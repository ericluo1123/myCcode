...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=../source/Main.c ../src/MCU_B1.c ../source/Chip.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/812168374/Main.p1 ${OBJECTDIR}/_ext/1360937237/MCU_B1.p1 ${OBJECTDIR}/_ext/812168374/Chip.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/812168374/Main.p1.d ${OBJECTDIR}/_ext/1360937237/MCU_B1.p1.d ${OBJECTDIR}/_ext/812168374/Chip.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/812168374/Main.p1 ${OBJECTDIR}/_ext/1360937237/MCU_B1.p1 ${OBJECTDIR}/_ext/812168374/Chip.p1

# Source Files
SOURCEFILES=../source/Main.c ../src/MCU_B1.c ../source/Chip.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/812168374/Chip.p1: ../source/Chip.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/_ext/812168374 
	@${RM} ${OBJECTDIR}/_ext/812168374/Chip.p1.d 
	@${RM} ${OBJECTDIR}/_ext/812168374/Chip.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/_ext/812168374/Chip.p1  ../source/Chip.c 
	@-${MV} ${OBJECTDIR}/_ext/812168374/Chip.d ${OBJECTDIR}/_ext/812168374/Chip.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/_ext/812168374/Chip.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,+osccal,-resetbits,-download,-stackcall,+clib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/SeriesName_Vsersion.X.${IMAGE_TYPE}.hex 
